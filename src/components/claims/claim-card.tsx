  ...
  return (
    <article className="group relative">
      ...
      >
        ...
        <div className="mt-auto flex flex-wrap items-center justify-between gap-3 border-t border-border pt-4 pr-28">
      ...
      <button
        ...
        className={`absolute right-3 bottom-3 inline-flex h-8 items-center gap-1.5 rounded-full border px-3 text-xs font-semibold transition-all ${
          voted
